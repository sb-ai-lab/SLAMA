...
def datasets() -> Dict[str, Any]:
    ...
    all_datastes = {
        ...
        "tiny_used_cars_dataset": {"path": "/opt/spark_data/tiny_used_cars_data_cleaned.csv", **base_used_cars},
        "used_cars_dataset_head50k": {"path": "/opt/spark_data/head50k_0125x_cleaned.csv", **base_used_cars},
        ...
        "used_cars_dataset_0125x": {"path": "/opt/spark_data/derivative_datasets/0125x_cleaned.csv", **base_used_cars},
        "used_cars_dataset_025x": {"path": "/opt/spark_data/derivative_datasets/025x_cleaned.csv", **base_used_cars},
        "used_cars_dataset_05x": {"path": "/opt/spark_data/derivative_datasets/05x_dataset.csv", **base_used_cars},
        "used_cars_dataset_1x": {"path": "/opt/spark_data/derivative_datasets/1x_dataset.csv", **base_used_cars},
        "used_cars_dataset_2x": {"path": "/opt/spark_data/derivative_datasets/2x_cleaned.csv", **base_used_cars},
        "used_cars_dataset_4x": {"path": "/opt/spark_data/derivative_datasets/4x_cleaned.csv", **base_used_cars},
        "lama_test_dataset": {
