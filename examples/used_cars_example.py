...
data = pd.read_csv(os.path.join("file://", os.getcwd(), "../data/tiny_used_cars_data.csv"))
...
if __name__ == "__main__":
    ...
    automl = TabularAutoML(task=task, general_params={"use_algos": ["linear_l2"]})
    ...
    print(f"MSE score for out-of-fold predictions: {mean_squared_error(train_data['price'].values, oof_predictions.data[:, 0])}")
