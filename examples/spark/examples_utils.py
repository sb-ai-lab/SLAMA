...
def get_spark_session():
    if os.environ.get("SCRIPT_ENV", None) == "cluster":
        ...
        spark_sess = (
            ...
            .config("spark.executor.extraClassPath", "/home/nikolay/.ivy2_backup3_3.0.1_and_0.9.5/jars/*")
            .config("spark.driver.extraClassPath", "/home/nikolay/.ivy2_backup3_3.0.1_and_0.9.5/jars/*")
            # .config("spark.executor.extraClassPath", "/home/nikolay/.ivy2/jars/*")
            # .config("spark.driver.extraClassPath", "/home/nikolay/.ivy2/jars/*")
