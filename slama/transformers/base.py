...
from lightautoml.transformers.base import LAMLTransformer, Roles
...
from slama.utils import SparkDataFrame, log_exec_time
...
class SparkColumnsAndRoles(HasInputCols, HasOutputCols, HasInputRoles, HasOutputRoles):
    """
    Helper and base class for :class:`~slama.transformers.base.SparkBaseTransformer` and
    :class:`~slama.transformers.base.SparkBaseEstimator`.
    """
...
class SparkBaseEstimator(Estimator, SparkColumnsAndRoles, ABC):
    """
    Base class for estimators from `slama.transformers`.
    """
...
class SparkBaseTransformer(Transformer, SparkColumnsAndRoles, ABC):
    """
    Base class for transformers from `slama.transformers`.
    """
