...
from slama.transformers.base import SparkBaseTransformer
...
class SparkDatetimeHelper:
    """
    Helper class for :class:`~slama.transformers.datetime.SparkTimeToNumTransformer`,
    :class:`~slama.transformers.datetime.SparkBaseDiffTransformer` and
    :class:`~slama.transformers.datetime.SparkDateSeasonsTransformer`
    """
