...
from slama.mlwriters import (
    CommonPickleMLReadable,
    CommonPickleMLWritable,
    SparkLabelEncoderTransformerMLReadable,
    SparkLabelEncoderTransformerMLWritable,
)
from slama.transformers.base import SparkBaseEstimator, SparkBaseTransformer
from slama.transformers.scala_wrappers.laml_string_indexer import (
    LAMLStringIndexer,
...
class SparkLabelEncoderEstimator(SparkBaseEstimator, TypesHelper):
    """
    Spark label encoder estimator. Returns :class:`~slama.transformers.categorical.SparkLabelEncoderTransformer`.
    """
...
class SparkOrdinalEncoderEstimator(SparkLabelEncoderEstimator):
    """
    Spark ordinal encoder estimator. Returns :class:`~slama.transformers.categorical.SparkOrdinalEncoderTransformer`.
    """
...
class SparkFreqEncoderEstimator(SparkLabelEncoderEstimator):
    """
    Calculates frequency in train data and produces :class:`~slama.transformers.categorical.SparkFreqEncoderTransformer` instance.
    """
...
class SparkCatIntersectionsHelper:
    """Helper class for :class:`~slama.transformers.categorical.SparkCatIntersectionsEstimator` and
    :class:`~slama.transformers.categorical.SparkCatIntersectionsTransformer`.
    """
...
class SparkCatIntersectionsEstimator(SparkCatIntersectionsHelper, SparkLabelEncoderEstimator):
    """
    Combines categorical features and fits :class:`~slama.transformers.categorical.SparkLabelEncoderEstimator`.
    Returns :class:`~slama.transformers.categorical.SparkCatIntersectionsTransformer`.
    """
...
class SparkTargetEncoderEstimator(SparkBaseEstimator):
    """
    Spark target encoder estimator. Returns :class:`~slama.transformers.categorical.SparkTargetEncoderTransformer`.
    """
...
class SparkMulticlassTargetEncoderEstimator(SparkBaseEstimator):
    """
    Spark multiclass target encoder estimator. Returns :class:`~slama.transformers.categorical.SparkMultiTargetEncoderTransformer`.
    """
