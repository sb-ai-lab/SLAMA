...
from slama.mlwriters import LAMLStringIndexerModelJavaMLReadable
...
class LAMLStringIndexerModel(
    ...
    def _from_java(java_stage):
        ...
        stage_name = "slama.transformers.scala_wrappers.laml_string_indexer.LAMLStringIndexerModel"
