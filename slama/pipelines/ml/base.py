...
from ..features.base import SparkEmptyFeaturePipeline, SparkFeaturesPipeline
...
class SparkMLPipeline(LAMAMLPipeline, OutputFeaturesAndRoles):
    ...
    (every step, excluding model training, is optional):
        ...
        - Features generation: build new features from selected.
          Performed by
          :class:`~slama.pipelines.features.base.SparkFeaturesPipeline`.
        ...
        - Train one or multiple ML models:
          Performed by :class:`~slama.ml_algo.base.SparkTabularMLAlgo`.
