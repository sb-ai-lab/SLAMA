...
from slama.pipelines.features.base import (
    SparkFeaturesPipeline,
    SparkTabularDataFeatures,
)
from slama.transformers.base import (
...
from slama.transformers.categorical import SparkLabelEncoderEstimator
from slama.transformers.numeric import (
...
class SparkLinearFeatures(SparkFeaturesPipeline, SparkTabularDataFeatures):
    ...
    def create_pipeline(self, train: SparkDataset) -> SparkEstOrTrans:
        ...
        if len(probs_list) > 0:
            ...
            probs_pipe = SparkSequentialTransformer(
                [
                    probs_pipe,
                    SparkLogOddsTransformer(
                        input_cols=probs_pipe.get_output_cols(),
        ...
        if len(dense_list) > 0:
            ...
            fill_inf_stage = SparkFillInfTransformer(
                input_cols=dense_pipe1.get_output_cols(),
        ...
        if len(sparse_list) > 0:
            ...
            if self.output_categories:
                final = SparkChangeRolesTransformer(
