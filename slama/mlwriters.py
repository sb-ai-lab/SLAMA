...
from synapse.ml.lightgbm import LightGBMClassificationModel, LightGBMRegressionModel
...
class ONNXModelWrapperMLReader(MLWriter):
    def load(self, path):
        ...
        from slama.ml_algo.boost_lgbm import ONNXModelWrapper
...
class LightGBMModelWrapperMLReader(MLReader):
    def load(self, path):
        ...
        from slama.ml_algo.boost_lgbm import LightGBMModelWrapper
