...
from lightautoml.reader.base import Reader, RolesDict, RoleType, UserDefinedRolesDict
...
from pyspark.sql.types import FloatType, IntegerType, NumericType, StringType

from slama.dataset.base import SparkDataset
from slama.mlwriters import CommonPickleMLReadable, CommonPickleMLWritable
from slama.reader.guess_roles import (
...
class SparkReaderHelper:
    """Helper class that provide some methods for :class:`~slama.reader.base.SparkToSparkReader` and
    :class:`~slama.reader.base.SparkToSparkReaderTransformer`.
    """
