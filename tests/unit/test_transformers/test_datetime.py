...
from lightautoml.transformers.datetime import BaseDiff, DateSeasons, TimeToNum
from pyspark.sql import SparkSession

from slama.transformers.datetime import (
...
def test_date_seasons(spark: SparkSession, dataset: DatasetForTest):
    ...
    compare_sparkml_by_content(
        spark, ds, DateSeasons(), SparkDateSeasonsTransformer(input_cols=ds.features, input_roles=ds.roles)
    )
